...
proc create_root_design { parentCell } {
  ...
  set TRIG_OUT [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:trigger_rtl:1.0 TRIG_OUT ]
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins g_inst/slot_0_axi]
  ...
  connect_bd_intf_net -intf_net ila_lib_TRIG_OUT [get_bd_intf_ports TRIG_OUT] [get_bd_intf_pins ila_lib/TRIG_OUT]
